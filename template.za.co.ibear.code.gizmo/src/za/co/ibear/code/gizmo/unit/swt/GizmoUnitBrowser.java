...
public class GizmoUnitBrowser extends GizmoUnit {

	public GizmoUnitBrowser(Unit unit) throws Exception {
		super(unit,unit.NAME + "Browser",unit.NAME + "Model",GizmoUnitEditorConstant.PACKAGE_PREFIX,GizmoUnitEditorConstant.PATH_PREFIX);
		...
		content = content + "import za.co.ibear.data.unit.swt." + unit.NAME.toLowerCase() + "." + unit.NAME + "LabelProvider;\n";
		...
		content = content + "public class " + unit.NAME + "Browser extends UnitBrowseComposite implements IProgressMonitor {\n";
		...
		content = content + "	public " + unit.NAME + "Browser(final Composite parent, int style,UnitBrowseDialogState state,Map<String,UnitBrowseDialogState> unitBorwseStateMap,final boolean SINGLE_SELECT,List<String> initFilter,Map<String,TreeSet<String>> selection) throws Exception  {\n";
		...
		content = content + "				latestState.setData(new ArrayList<" + unit.NAME + "Model>());\n";
		content = content + "				latestState.getData().addAll(data.getData());\n";
		content = content + "				latestState.setFilterData(new ArrayList<" + unit.NAME + "Model>());\n";
		...
		content = content + "				Set<" + unit.NAME + "Model> selectedModels = new HashSet<" + unit.NAME + "Model>(); \n";
		content = content + "				for(TableItem item:dataTable.getSelection()) {\n";
		content = content + "					selectedModels.add((" + unit.NAME + "Model) item.getData());\n";
		content = content + "				}\n";
		content = content + "				JFilter<" + unit.NAME + "Model> filter = new JFilter<" + unit.NAME + "Model>(selectedModels, " + unit.NAME + "Model.class);\n";
		content = content + "				Map<String,TreeSet<String>> selection = new HashMap<String,TreeSet<String>>();\n";
		content = content + "				Set<PrimaryKey> keySet = meta.PRIMARY_KEY;\n";
		...
		content = content + "			data.filter(" + unit.NAME + ",getInitFilter());\n";
		content = content + "		}\n";
