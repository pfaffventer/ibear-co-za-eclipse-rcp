...
public class GizmoEditComposite_Unit extends GizmoUnitEditCombo {

	public GizmoEditComposite_Unit() throws Exception {
		super("UnitEditComposite",GizmoUnitEditorConstant.PACKAGE_PREFIX,GizmoUnitEditorConstant.PATH_PREFIX);
		...
		content = content + "public class UnitEditComposite extends Composite {\n";
		content = content + "	private PropertyChangeSupport changeSupport = new PropertyChangeSupport(this);\n";
		content = content + "	public UnitEditComposite(Composite parent, int style) {\n";
