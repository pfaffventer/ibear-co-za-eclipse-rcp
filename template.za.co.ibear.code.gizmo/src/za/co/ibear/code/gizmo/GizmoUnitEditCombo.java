...
public class GizmoUnitEditCombo {
	...
	public GizmoUnitEditCombo(String className,String packagePrefix, String pathPrefix) {
		super();
		this.className = className;
		this.packagePrefix = packagePrefix;
		this.pathPrefix = pathPrefix;
		this.content = "package " + packagePrefix + "edit" + ";\n\n";
	}
	...
	protected void p(String v) {
		System.out.println("GizmoUnitEditCombo:) " + v);
	}
